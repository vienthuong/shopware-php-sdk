...
class DocumentDefinition implements EntityDefinition
{
    ...
    public function getSchema() : Schema
    {
        return new Schema('document', new PropertyCollection([
            ...
            new Property('documentType', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource']]), new Flag('search_ranking', 0.25), ]), ['entity' => 'document_type', 'referenceField' => 'id', 'localField' => 'documentTypeId', 'relation' => 'many_to_one', ]),
            ...
            new Property('referencedDocument', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource']]), ]), ['entity' => 'document', 'referenceField' => 'id', 'localField' => 'referencedDocumentId', 'relation' => 'many_to_one', ]),
            new Property('dependentDocuments', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource']]), ]), ['entity' => 'document', 'referenceField' => 'referencedDocumentId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
            new Property('documentMediaFile', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource']]), ]), ['entity' => 'media', 'referenceField' => 'id', 'localField' => 'documentMediaFileId', 'relation' => 'many_to_one', ]),
