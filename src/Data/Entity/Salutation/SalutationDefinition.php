...
class SalutationDefinition implements EntityDefinition
{
    ...
    public function getSchema() : Schema
    {
        return new Schema('salutation', new PropertyCollection([
            ...
            new Property('customers', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('restrict_delete', 1), ]), ['entity' => 'customer', 'referenceField' => 'salutationId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
            new Property('customerAddresses', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('restrict_delete', 1), ]), ['entity' => 'customer_address', 'referenceField' => 'salutationId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
            new Property('orderCustomers', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('restrict_delete', 1), ]), ['entity' => 'order_customer', 'referenceField' => 'salutationId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
            new Property('orderAddresses', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('restrict_delete', 1), ]), ['entity' => 'order_address', 'referenceField' => 'salutationId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
            new Property('newsletterRecipients', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('restrict_delete', 1), ]), ['entity' => 'newsletter_recipient', 'referenceField' => 'salutationId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
