...
class MediaDefinition implements EntityDefinition
{
    ...
    public function getSchema() : Schema
    {
        return new Schema('media', new PropertyCollection([
            ...
            new Property('avatarUser', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('cascade_delete', 1), ]), ['entity' => 'user', 'referenceField' => 'avatarId', 'localField' => 'id', 'relation' => 'one_to_one', ]),
