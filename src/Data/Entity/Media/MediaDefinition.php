...
class MediaDefinition implements EntityDefinition
{
    ...
    public function getSchema() : Schema
    {
        return new Schema('media', new PropertyCollection([
            ...
            new Property('translations', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource']]), new Flag('cascade_delete', 1), new Flag('required', 1), ]), ['entity' => 'media_translation', 'referenceField' => 'mediaId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
            new Property('tags', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('search_ranking', 0.25), ]), ['entity' => 'tag', 'referenceField' => 'id', 'localField' => 'id', 'relation' => 'many_to_many', ]),
            new Property('thumbnails', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource']]), new Flag('cascade_delete', 1), ]), ['entity' => 'media_thumbnail', 'referenceField' => 'mediaId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
            ...
            new Property('categories', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('set_null_on_delete', 1), ]), ['entity' => 'category', 'referenceField' => 'mediaId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
            new Property('productManufacturers', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('set_null_on_delete', 1), ]), ['entity' => 'product_manufacturer', 'referenceField' => 'mediaId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
            new Property('productMedia', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('cascade_delete', 1), ]), ['entity' => 'product_media', 'referenceField' => 'mediaId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
            new Property('productDownloads', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('restrict_delete', 1), ]), ['entity' => 'product_download', 'referenceField' => 'mediaId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
            new Property('orderLineItemDownloads', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('restrict_delete', 1), ]), ['entity' => 'order_line_item_download', 'referenceField' => 'mediaId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
            new Property('avatarUsers', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('set_null_on_delete', 1), ]), ['entity' => 'user', 'referenceField' => 'avatarId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
            new Property('mediaFolder', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), ]), ['entity' => 'media_folder', 'referenceField' => 'id', 'localField' => 'mediaFolderId', 'relation' => 'many_to_one', ]),
            new Property('propertyGroupOptions', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('set_null_on_delete', 1), ]), ['entity' => 'property_group_option', 'referenceField' => 'mediaId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
            new Property('mailTemplateMedia', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('cascade_delete', 1), ]), ['entity' => 'mail_template_media', 'referenceField' => 'mediaId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
            new Property('documentBaseConfigs', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('set_null_on_delete', 1), ]), ['entity' => 'document_base_config', 'referenceField' => 'logoId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
            new Property('shippingMethods', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('set_null_on_delete', 1), ]), ['entity' => 'shipping_method', 'referenceField' => 'mediaId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
            new Property('paymentMethods', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('set_null_on_delete', 1), ]), ['entity' => 'payment_method', 'referenceField' => 'mediaId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
            new Property('productConfiguratorSettings', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('set_null_on_delete', 1), ]), ['entity' => 'product_configurator_setting', 'referenceField' => 'mediaId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
            new Property('orderLineItems', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('set_null_on_delete', 1), ]), ['entity' => 'order_line_item', 'referenceField' => 'coverId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
            new Property('cmsBlocks', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('restrict_delete', 1), ]), ['entity' => 'cms_block', 'referenceField' => 'backgroundMediaId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
            new Property('cmsSections', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('restrict_delete', 1), ]), ['entity' => 'cms_section', 'referenceField' => 'backgroundMediaId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
            ...
            new Property('themeMedia', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('extension', 1), ]), ['entity' => 'theme', 'referenceField' => 'id', 'localField' => 'id', 'relation' => 'many_to_many', ]),
