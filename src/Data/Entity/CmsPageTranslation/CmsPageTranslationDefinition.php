...
class CmsPageTranslationDefinition implements EntityDefinition
{
    ...
    public function getSchema() : Schema
    {
        return new Schema('cms_page_translation', new PropertyCollection([
            ...
            new Property('cmsPage', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), ]), ['entity' => 'cms_page', 'referenceField' => 'id', 'localField' => 'cmsPageId', 'relation' => 'many_to_one', ]),
