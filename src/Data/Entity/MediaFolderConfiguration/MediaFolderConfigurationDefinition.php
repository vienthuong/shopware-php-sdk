...
class MediaFolderConfigurationDefinition implements EntityDefinition
{
    ...
    public function getSchema() : Schema
    {
        return new Schema('media_folder_configuration', new PropertyCollection([
            ...
            new Property('mediaFolders', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), ]), ['entity' => 'media_folder', 'referenceField' => 'configurationId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
            new Property('mediaThumbnailSizes', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), ]), ['entity' => 'media_thumbnail_size', 'referenceField' => 'id', 'localField' => 'id', 'relation' => 'many_to_many', ]),
