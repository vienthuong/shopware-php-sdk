...
class TaxRuleTypeDefinition implements EntityDefinition
{
    ...
    public function getSchema() : Schema
    {
        return new Schema('tax_rule_type', new PropertyCollection([
            ...
            new Property('rules', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('restrict_delete', 1), ]), ['entity' => 'tax_rule', 'referenceField' => 'taxRuleTypeId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
            new Property('translations', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('cascade_delete', 1), new Flag('required', 1), ]), ['entity' => 'tax_rule_type_translation', 'referenceField' => 'taxRuleTypeId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
