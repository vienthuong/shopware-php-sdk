...
class UserDefinition implements EntityDefinition
{
    ...
    public function getSchema() : Schema
    {
        return new Schema('user', new PropertyCollection([
            ...
            new Property('avatarMedia', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), ]), ['entity' => 'media', 'referenceField' => 'id', 'localField' => 'avatarId', 'relation' => 'many_to_one', ]),
            new Property('media', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('set_null_on_delete', 1), ]), ['entity' => 'media', 'referenceField' => 'userId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
            new Property('accessKeys', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('cascade_delete', 1), ]), ['entity' => 'user_access_key', 'referenceField' => 'userId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
            new Property('configs', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('cascade_delete', 1), ]), ['entity' => 'user_config', 'referenceField' => 'userId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
            new Property('stateMachineHistoryEntries', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), ]), ['entity' => 'state_machine_history', 'referenceField' => 'userId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
            new Property('importExportLogEntries', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('set_null_on_delete', 1), ]), ['entity' => 'import_export_log', 'referenceField' => 'userId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
            ...
            new Property('recoveryUser', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), ]), ['entity' => 'user_recovery', 'referenceField' => 'userId', 'localField' => 'id', 'relation' => 'one_to_one', ]),
            new Property('storeToken', 'string', new FlagCollection([]), []),
            new Property('createdOrders', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), ]), ['entity' => 'order', 'referenceField' => 'createdById', 'localField' => 'id', 'relation' => 'one_to_many', ]),
            ...
            new Property('createdCustomers', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), ]), ['entity' => 'customer', 'referenceField' => 'createdById', 'localField' => 'id', 'relation' => 'one_to_many', ]),
            new Property('updatedCustomers', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), ]), ['entity' => 'customer', 'referenceField' => 'updatedById', 'localField' => 'id', 'relation' => 'one_to_many', ]),
