...
class AppActionButtonTranslationDefinition implements EntityDefinition
{
    ...
    public function getSchema() : Schema
    {
        return new Schema('app_action_button_translation', new PropertyCollection([
            ...
            new Property('appActionButton', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), ]), ['entity' => 'app_action_button', 'referenceField' => 'id', 'localField' => 'appActionButtonId', 'relation' => 'many_to_one', ]),
