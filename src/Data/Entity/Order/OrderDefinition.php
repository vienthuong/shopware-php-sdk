...
class OrderDefinition implements EntityDefinition
{
    ...
    public function getSchema() : Schema
    {
        return new Schema('order', new PropertyCollection([
            ...
            new Property('billingAddressId', 'uuid', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource']]), new Flag('required', 1), ]), []),
            ...
            new Property('orderCustomer', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource']]), new Flag('cascade_delete', 1), new Flag('search_ranking', 0.5), ]), ['entity' => 'order_customer', 'referenceField' => 'orderId', 'localField' => 'id', 'relation' => 'one_to_one', ]),
            ...
            new Property('addresses', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource']]), new Flag('cascade_delete', 1), new Flag('search_ranking', 0.25), ]), ['entity' => 'order_address', 'referenceField' => 'orderId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
            new Property('billingAddress', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource']]), ]), ['entity' => 'order_address', 'referenceField' => 'id', 'localField' => 'billingAddressId', 'relation' => 'many_to_one', ]),
            new Property('deliveries', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource']]), new Flag('cascade_delete', 1), new Flag('search_ranking', 0.25), ]), ['entity' => 'order_delivery', 'referenceField' => 'orderId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
            new Property('lineItems', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource']]), new Flag('cascade_delete', 1), ]), ['entity' => 'order_line_item', 'referenceField' => 'orderId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
            new Property('transactions', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource']]), new Flag('cascade_delete', 1), ]), ['entity' => 'order_transaction', 'referenceField' => 'orderId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
            new Property('documents', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource']]), ]), ['entity' => 'document', 'referenceField' => 'orderId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
            ...
            new Property('itemRounding', 'json_object', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), ]), ['properties' => json_decode('{"decimals":{"type":"int","flags":{"read_protected":[["Shopware\\Core\\Framework\\Api\\Context\\AdminApiSource"]]}},"interval":{"type":"float","flags":{"read_protected":[["Shopware\\Core\\Framework\\Api\\Context\\AdminApiSource"]]}},"roundForNet":{"type":"boolean","flags":{"read_protected":[["Shopware\\Core\\Framework\\Api\\Context\\AdminApiSource"]]}}}', true), ]),
            new Property('totalRounding', 'json_object', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), ]), ['properties' => json_decode('{"decimals":{"type":"int","flags":{"read_protected":[["Shopware\\Core\\Framework\\Api\\Context\\AdminApiSource"]]}},"interval":{"type":"float","flags":{"read_protected":[["Shopware\\Core\\Framework\\Api\\Context\\AdminApiSource"]]}},"roundForNet":{"type":"boolean","flags":{"read_protected":[["Shopware\\Core\\Framework\\Api\\Context\\AdminApiSource"]]}}}', true), ]),
