...
class OrderDeliveryPositionDefinition implements EntityDefinition
{
    ...
    public function getSchema() : Schema
    {
        return new Schema('order_delivery_position', new PropertyCollection([
            ...
            new Property('orderDelivery', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), ]), ['entity' => 'order_delivery', 'referenceField' => 'id', 'localField' => 'orderDeliveryId', 'relation' => 'many_to_one', ]),
            new Property('orderLineItem', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), ]), ['entity' => 'order_line_item', 'referenceField' => 'id', 'localField' => 'orderLineItemId', 'relation' => 'many_to_one', ]),
