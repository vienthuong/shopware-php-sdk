...
class ProductSearchConfigDefinition implements EntityDefinition
{
    ...
    public function getSchema() : Schema
    {
        return new Schema('product_search_config', new PropertyCollection([
            ...
            new Property('language', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), ]), ['entity' => 'language', 'referenceField' => 'id', 'localField' => 'languageId', 'relation' => 'one_to_one', ]),
            new Property('configFields', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('cascade_delete', 1), ]), ['entity' => 'product_search_config_field', 'referenceField' => 'searchConfigId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
