...
class ShippingMethodDefinition implements EntityDefinition
{
    ...
    public function getSchema() : Schema
    {
        return new Schema('shipping_method', new PropertyCollection([
            ...
            new Property('deliveryTime', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource']]), ]), ['entity' => 'delivery_time', 'referenceField' => 'id', 'localField' => 'deliveryTimeId', 'relation' => 'many_to_one', ]),
            ...
            new Property('translations', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource']]), new Flag('cascade_delete', 1), new Flag('required', 1), ]), ['entity' => 'shipping_method_translation', 'referenceField' => 'shippingMethodId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
            new Property('availabilityRule', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource']]), ]), ['entity' => 'rule', 'referenceField' => 'id', 'localField' => 'availabilityRuleId', 'relation' => 'many_to_one', ]),
            new Property('prices', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource']]), new Flag('cascade_delete', 1), ]), ['entity' => 'shipping_method_price', 'referenceField' => 'shippingMethodId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
            ...
            new Property('tags', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource']]), ]), ['entity' => 'tag', 'referenceField' => 'id', 'localField' => 'id', 'relation' => 'many_to_many', ]),
            new Property('orderDeliveries', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('restrict_delete', 1), ]), ['entity' => 'order_delivery', 'referenceField' => 'shippingMethodId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
            ...
            new Property('salesChannelDefaultAssignments', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('restrict_delete', 1), ]), ['entity' => 'sales_channel', 'referenceField' => 'shippingMethodId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
            new Property('tax', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource']]), ]), ['entity' => 'tax', 'referenceField' => 'id', 'localField' => 'taxId', 'relation' => 'many_to_one', ]),
            new Property('appShippingMethod', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('cascade_delete', 1), ]), ['entity' => 'app_shipping_method', 'referenceField' => 'shippingMethodId', 'localField' => 'id', 'relation' => 'one_to_one', ]),
