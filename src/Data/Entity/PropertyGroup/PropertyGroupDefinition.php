...
class PropertyGroupDefinition implements EntityDefinition
{
    ...
    public function getSchema() : Schema
    {
        return new Schema('property_group', new PropertyCollection([
            ...
            new Property('options', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource']]), new Flag('cascade_delete', 1), new Flag('search_ranking', 0.25), ]), ['entity' => 'property_group_option', 'referenceField' => 'groupId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
            new Property('translations', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('cascade_delete', 1), new Flag('required', 1), ]), ['entity' => 'property_group_translation', 'referenceField' => 'propertyGroupId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
