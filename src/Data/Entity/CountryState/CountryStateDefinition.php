...
class CountryStateDefinition implements EntityDefinition
{
    ...
    public function getSchema() : Schema
    {
        return new Schema('country_state', new PropertyCollection([
            ...
            new Property('translations', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('cascade_delete', 1), new Flag('required', 1), ]), ['entity' => 'country_state_translation', 'referenceField' => 'countryStateId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
            new Property('customerAddresses', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('set_null_on_delete', 1), ]), ['entity' => 'customer_address', 'referenceField' => 'countryStateId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
            new Property('orderAddresses', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('set_null_on_delete', 1), ]), ['entity' => 'order_address', 'referenceField' => 'countryStateId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
