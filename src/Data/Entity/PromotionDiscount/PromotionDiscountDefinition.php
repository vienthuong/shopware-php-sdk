...
class PromotionDiscountDefinition implements EntityDefinition
{
    ...
    public function getSchema() : Schema
    {
        return new Schema('promotion_discount', new PropertyCollection([
            ...
            new Property('discountRules', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('cascade_delete', 1), ]), ['entity' => 'rule', 'referenceField' => 'id', 'localField' => 'id', 'relation' => 'many_to_many', ]),
            new Property('promotionDiscountPrices', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('cascade_delete', 1), ]), ['entity' => 'promotion_discount_prices', 'referenceField' => 'discountId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
