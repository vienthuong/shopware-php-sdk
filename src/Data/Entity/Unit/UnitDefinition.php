...
class UnitDefinition implements EntityDefinition
{
    ...
    public function getSchema() : Schema
    {
        return new Schema('unit', new PropertyCollection([
            ...
            new Property('products', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('restrict_delete', 1), new Flag('reversed_inherited', 'unit'), ]), ['entity' => 'product', 'referenceField' => 'unitId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
            new Property('translations', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('cascade_delete', 1), new Flag('required', 1), ]), ['entity' => 'unit_translation', 'referenceField' => 'unitId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
