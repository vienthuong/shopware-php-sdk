...
class DocumentTypeDefinition implements EntityDefinition
{
    ...
    public function getSchema() : Schema
    {
        return new Schema('document_type', new PropertyCollection([
            ...
            new Property('translations', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource']]), new Flag('cascade_delete', 1), new Flag('required', 1), ]), ['entity' => 'document_type_translation', 'referenceField' => 'documentTypeId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
            new Property('documents', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), ]), ['entity' => 'document', 'referenceField' => 'documentTypeId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
            new Property('documentBaseConfigs', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('cascade_delete', 1), ]), ['entity' => 'document_base_config', 'referenceField' => 'documentTypeId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
            new Property('documentBaseConfigSalesChannels', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('cascade_delete', 1), ]), ['entity' => 'document_base_config_sales_channel', 'referenceField' => 'documentTypeId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
