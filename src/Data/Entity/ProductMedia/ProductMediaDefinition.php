...
class ProductMediaDefinition implements EntityDefinition
{
    ...
    public function getSchema() : Schema
    {
        return new Schema('product_media', new PropertyCollection([
            ...
            new Property('product', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('reversed_inherited', 'media'), ]), ['entity' => 'product', 'referenceField' => 'id', 'localField' => 'productId', 'relation' => 'many_to_one', ]),
            ...
            new Property('coverProducts', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('set_null_on_delete', 1), ]), ['entity' => 'product', 'referenceField' => 'coverId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
