...
class AppScriptConditionTranslationDefinition implements EntityDefinition
{
    ...
    public function getSchema() : Schema
    {
        return new Schema('app_script_condition_translation', new PropertyCollection([
            ...
            new Property('appScriptCondition', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), ]), ['entity' => 'app_script_condition', 'referenceField' => 'id', 'localField' => 'appScriptConditionId', 'relation' => 'many_to_one', ]),
