...
class TaxDefinition implements EntityDefinition
{
    ...
    public function getSchema() : Schema
    {
        return new Schema('tax', new PropertyCollection([
            ...
            new Property('products', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('restrict_delete', 1), new Flag('reversed_inherited', 'tax'), ]), ['entity' => 'product', 'referenceField' => 'taxId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
            new Property('rules', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('restrict_delete', 1), ]), ['entity' => 'tax_rule', 'referenceField' => 'taxId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
            new Property('shippingMethods', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('restrict_delete', 1), ]), ['entity' => 'shipping_method', 'referenceField' => 'taxId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
