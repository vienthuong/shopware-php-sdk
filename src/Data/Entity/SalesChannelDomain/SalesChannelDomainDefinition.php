...
class SalesChannelDomainDefinition implements EntityDefinition
{
    ...
    public function getSchema() : Schema
    {
        return new Schema('sales_channel_domain', new PropertyCollection([
            ...
            new Property('snippetSet', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), ]), ['entity' => 'snippet_set', 'referenceField' => 'id', 'localField' => 'snippetSetId', 'relation' => 'many_to_one', ]),
            new Property('salesChannelDefaultHreflang', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource']]), ]), ['entity' => 'sales_channel', 'referenceField' => 'hreflangDefaultDomainId', 'localField' => 'id', 'relation' => 'one_to_one', ]),
            new Property('productExports', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), ]), ['entity' => 'product_export', 'referenceField' => 'salesChannelDomainId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
