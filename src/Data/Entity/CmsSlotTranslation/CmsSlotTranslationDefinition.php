...
class CmsSlotTranslationDefinition implements EntityDefinition
{
    ...
    public function getSchema() : Schema
    {
        return new Schema('cms_slot_translation', new PropertyCollection([
            ...
            new Property('cmsSlot', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), ]), ['entity' => 'cms_slot', 'referenceField' => 'id', 'localField' => 'cmsSlotId', 'relation' => 'many_to_one', ]),
