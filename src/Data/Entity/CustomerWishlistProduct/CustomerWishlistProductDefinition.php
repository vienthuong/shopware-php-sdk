...
class CustomerWishlistProductDefinition implements EntityDefinition
{
    ...
    public function getSchema() : Schema
    {
        return new Schema('customer_wishlist_product', new PropertyCollection([
            ...
            new Property('wishlist', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), ]), ['entity' => 'customer_wishlist', 'referenceField' => 'id', 'localField' => 'wishlistId', 'relation' => 'many_to_one', ]),
