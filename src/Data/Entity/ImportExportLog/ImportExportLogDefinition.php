...
class ImportExportLogDefinition implements EntityDefinition
{
    ...
    public function getSchema() : Schema
    {
        return new Schema('import_export_log', new PropertyCollection([
            ...
            new Property('invalidRecordsLog', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), ]), ['entity' => 'import_export_log', 'referenceField' => 'id', 'localField' => 'invalidRecordsLogId', 'relation' => 'one_to_one', ]),
            new Property('failedImportLog', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), ]), ['entity' => 'import_export_log', 'referenceField' => 'invalidRecordsLogId', 'localField' => 'id', 'relation' => 'one_to_one', ]),
