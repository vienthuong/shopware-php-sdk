...
class CustomerDefinition implements EntityDefinition
{
    ...
    public function getSchema() : Schema
    {
        return new Schema('customer', new PropertyCollection([
            ...
            new Property('group', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource']]), ]), ['entity' => 'customer_group', 'referenceField' => 'id', 'localField' => 'groupId', 'relation' => 'many_to_one', ]),
            new Property('defaultPaymentMethod', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource']]), new Flag('search_ranking', 0.25), ]), ['entity' => 'payment_method', 'referenceField' => 'id', 'localField' => 'defaultPaymentMethodId', 'relation' => 'many_to_one', ]),
            ...
            new Property('lastPaymentMethod', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource']]), ]), ['entity' => 'payment_method', 'referenceField' => 'id', 'localField' => 'lastPaymentMethodId', 'relation' => 'many_to_one', ]),
            new Property('defaultBillingAddress', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource']]), new Flag('search_ranking', 0.25), ]), ['entity' => 'customer_address', 'referenceField' => 'id', 'localField' => 'defaultBillingAddressId', 'relation' => 'many_to_one', ]),
            new Property('activeBillingAddress', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\SalesChannelApiSource']]), new Flag('runtime', 1), ]), ['entity' => 'customer_address', 'referenceField' => 'id', 'relation' => 'many_to_one', ]),
            new Property('defaultShippingAddress', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource']]), new Flag('search_ranking', 0.25), ]), ['entity' => 'customer_address', 'referenceField' => 'id', 'localField' => 'defaultShippingAddressId', 'relation' => 'many_to_one', ]),
            new Property('activeShippingAddress', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\SalesChannelApiSource']]), new Flag('runtime', 1), ]), ['entity' => 'customer_address', 'referenceField' => 'id', 'relation' => 'many_to_one', ]),
            new Property('salutation', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource']]), ]), ['entity' => 'salutation', 'referenceField' => 'id', 'localField' => 'salutationId', 'relation' => 'many_to_one', ]),
            new Property('addresses', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource']]), new Flag('cascade_delete', 1), ]), ['entity' => 'customer_address', 'referenceField' => 'customerId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
            new Property('orderCustomers', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('set_null_on_delete', 1), ]), ['entity' => 'order_customer', 'referenceField' => 'customerId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
            new Property('tags', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource']]), new Flag('search_ranking', 0.25), ]), ['entity' => 'tag', 'referenceField' => 'id', 'localField' => 'id', 'relation' => 'many_to_many', ]),
            new Property('promotions', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), ]), ['entity' => 'promotion', 'referenceField' => 'id', 'localField' => 'id', 'relation' => 'many_to_many', ]),
            new Property('productReviews', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), ]), ['entity' => 'product_review', 'referenceField' => 'customerId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
            new Property('recoveryCustomer', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), ]), ['entity' => 'customer_recovery', 'referenceField' => 'customerId', 'localField' => 'id', 'relation' => 'one_to_one', ]),
            ...
            new Property('requestedGroup', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), ]), ['entity' => 'customer_group', 'referenceField' => 'id', 'localField' => 'requestedGroupId', 'relation' => 'many_to_one', ]),
            ...
            new Property('boundSalesChannel', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), ]), ['entity' => 'sales_channel', 'referenceField' => 'id', 'localField' => 'boundSalesChannelId', 'relation' => 'many_to_one', ]),
            new Property('wishlists', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('cascade_delete', 1), ]), ['entity' => 'customer_wishlist', 'referenceField' => 'customerId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
            ...
            new Property('createdBy', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), ]), ['entity' => 'user', 'referenceField' => 'id', 'localField' => 'createdById', 'relation' => 'many_to_one', ]),
            new Property('updatedBy', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), ]), ['entity' => 'user', 'referenceField' => 'id', 'localField' => 'updatedById', 'relation' => 'many_to_one', ]),
