...
use Vin\ShopwareSdk\Data\Entity\v6580\AclRole\AclRoleEntity;
use Vin\ShopwareSdk\Data\Entity\v6580\AppActionButton\AppActionButtonCollection;
use Vin\ShopwareSdk\Data\Entity\v6580\AppCmsBlock\AppCmsBlockCollection;
use Vin\ShopwareSdk\Data\Entity\v6580\AppFlowAction\AppFlowActionCollection;
use Vin\ShopwareSdk\Data\Entity\v6580\AppFlowEvent\AppFlowEventCollection;
use Vin\ShopwareSdk\Data\Entity\v6580\AppPaymentMethod\AppPaymentMethodCollection;
use Vin\ShopwareSdk\Data\Entity\v6580\AppScriptCondition\AppScriptConditionCollection;
use Vin\ShopwareSdk\Data\Entity\v6580\AppShippingMethod\AppShippingMethodCollection;
use Vin\ShopwareSdk\Data\Entity\v6580\AppTemplate\AppTemplateCollection;
use Vin\ShopwareSdk\Data\Entity\v6580\AppTranslation\AppTranslationCollection;
use Vin\ShopwareSdk\Data\Entity\v6580\CustomFieldSet\CustomFieldSetCollection;
use Vin\ShopwareSdk\Data\Entity\v6580\Integration\IntegrationEntity;
use Vin\ShopwareSdk\Data\Entity\v6580\Script\ScriptCollection;
use Vin\ShopwareSdk\Data\Entity\v6580\TaxProvider\TaxProviderCollection;
use Vin\ShopwareSdk\Data\Entity\v6580\Webhook\WebhookCollection;
