...
class PaymentMethodDefinition implements EntityDefinition
{
    ...
    public function getSchema() : Schema
    {
        return new Schema('payment_method', new PropertyCollection([
            ...
            new Property('handlerIdentifier', 'string', new FlagCollection([]), []),
            ...
            new Property('translations', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource']]), new Flag('cascade_delete', 1), new Flag('required', 1), ]), ['entity' => 'payment_method_translation', 'referenceField' => 'paymentMethodId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
            ...
            new Property('availabilityRule', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), ]), ['entity' => 'rule', 'referenceField' => 'id', 'localField' => 'availabilityRuleId', 'relation' => 'many_to_one', ]),
            new Property('salesChannelDefaultAssignments', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('restrict_delete', 1), ]), ['entity' => 'sales_channel', 'referenceField' => 'paymentMethodId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
            new Property('plugin', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), ]), ['entity' => 'plugin', 'referenceField' => 'id', 'localField' => 'pluginId', 'relation' => 'many_to_one', ]),
            new Property('customers', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('restrict_delete', 1), ]), ['entity' => 'customer', 'referenceField' => 'lastPaymentMethodId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
            new Property('orderTransactions', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('restrict_delete', 1), ]), ['entity' => 'order_transaction', 'referenceField' => 'paymentMethodId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
            ...
            new Property('appPaymentMethod', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('cascade_delete', 1), ]), ['entity' => 'app_payment_method', 'referenceField' => 'paymentMethodId', 'localField' => 'id', 'relation' => 'one_to_one', ]),
