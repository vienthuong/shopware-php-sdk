...
class OrderDeliveryDefinition implements EntityDefinition
{
    ...
    public function getSchema() : Schema
    {
        return new Schema('order_delivery', new PropertyCollection([
            ...
            new Property('shippingOrderAddress', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource']]), new Flag('search_ranking', 0.25), ]), ['entity' => 'order_address', 'referenceField' => 'id', 'localField' => 'shippingOrderAddressId', 'relation' => 'many_to_one', ]),
            new Property('shippingMethod', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource']]), new Flag('search_ranking', 0.25), ]), ['entity' => 'shipping_method', 'referenceField' => 'id', 'localField' => 'shippingMethodId', 'relation' => 'many_to_one', ]),
            new Property('positions', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource']]), new Flag('cascade_delete', 1), new Flag('search_ranking', 0.25), ]), ['entity' => 'order_delivery_position', 'referenceField' => 'orderDeliveryId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
