...
class MailTemplateTypeDefinition implements EntityDefinition
{
    ...
    public function getSchema() : Schema
    {
        return new Schema('mail_template_type', new PropertyCollection([
            ...
            new Property('translations', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource']]), new Flag('cascade_delete', 1), new Flag('required', 1), ]), ['entity' => 'mail_template_type_translation', 'referenceField' => 'mailTemplateTypeId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
            new Property('mailTemplates', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('set_null_on_delete', 1), ]), ['entity' => 'mail_template', 'referenceField' => 'mailTemplateTypeId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
