...
class NumberRangeDefinition implements EntityDefinition
{
    ...
    public function getSchema() : Schema
    {
        return new Schema('number_range', new PropertyCollection([
            ...
            new Property('type', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), ]), ['entity' => 'number_range_type', 'referenceField' => 'id', 'localField' => 'typeId', 'relation' => 'many_to_one', ]),
            new Property('numberRangeSalesChannels', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('cascade_delete', 1), ]), ['entity' => 'number_range_sales_channel', 'referenceField' => 'numberRangeId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
            new Property('state', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('cascade_delete', 1), ]), ['entity' => 'number_range_state', 'referenceField' => 'numberRangeId', 'localField' => 'id', 'relation' => 'one_to_one', ]),
            new Property('translations', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('cascade_delete', 1), new Flag('required', 1), ]), ['entity' => 'number_range_translation', 'referenceField' => 'numberRangeId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
