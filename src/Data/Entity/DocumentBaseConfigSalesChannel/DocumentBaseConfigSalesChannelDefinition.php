...
class DocumentBaseConfigSalesChannelDefinition implements EntityDefinition
{
    ...
    public function getSchema() : Schema
    {
        return new Schema('document_base_config_sales_channel', new PropertyCollection([
            ...
            new Property('documentType', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), ]), ['entity' => 'document_type', 'referenceField' => 'id', 'localField' => 'documentTypeId', 'relation' => 'many_to_one', ]),
            new Property('documentBaseConfig', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), ]), ['entity' => 'document_base_config', 'referenceField' => 'id', 'localField' => 'documentBaseConfigId', 'relation' => 'many_to_one', ]),
