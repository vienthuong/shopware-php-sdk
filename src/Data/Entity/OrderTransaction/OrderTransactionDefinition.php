...
class OrderTransactionDefinition implements EntityDefinition
{
    ...
    public function getSchema() : Schema
    {
        return new Schema('order_transaction', new PropertyCollection([
            ...
            new Property('captures', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource']]), new Flag('cascade_delete', 1), ]), ['entity' => 'order_transaction_capture', 'referenceField' => 'orderTransactionId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
