...
class PropertyGroupOptionTranslationDefinition implements EntityDefinition
{
    ...
    public function getSchema() : Schema
    {
        return new Schema('property_group_option_translation', new PropertyCollection([
            ...
            new Property('propertyGroupOption', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), ]), ['entity' => 'property_group_option', 'referenceField' => 'id', 'localField' => 'propertyGroupOptionId', 'relation' => 'many_to_one', ]),
