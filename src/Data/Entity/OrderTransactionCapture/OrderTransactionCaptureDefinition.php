...
class OrderTransactionCaptureDefinition implements EntityDefinition
{
    ...
    public function getSchema() : Schema
    {
        return new Schema('order_transaction_capture', new PropertyCollection([
            ...
            new Property('transaction', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource']]), ]), ['entity' => 'order_transaction', 'referenceField' => 'id', 'localField' => 'orderTransactionId', 'relation' => 'many_to_one', ]),
            new Property('refunds', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource']]), new Flag('cascade_delete', 1), ]), ['entity' => 'order_transaction_capture_refund', 'referenceField' => 'captureId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
            ...
            new Property('totalAmount', 'float', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource']]), new Flag('runtime', 1), ]), []),
