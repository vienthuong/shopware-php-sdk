...
class RuleConditionDefinition implements EntityDefinition
{
    ...
    public function getSchema() : Schema
    {
        return new Schema('rule_condition', new PropertyCollection([
            ...
            new Property('appScriptCondition', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), ]), ['entity' => 'app_script_condition', 'referenceField' => 'id', 'localField' => 'scriptId', 'relation' => 'many_to_one', ]),
