...
class AppFlowActionDefinition implements EntityDefinition
{
    ...
    public function getSchema() : Schema
    {
        return new Schema('app_flow_action', new PropertyCollection([
            ...
            new Property('translations', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('cascade_delete', 1), new Flag('required', 1), ]), ['entity' => 'app_flow_action_translation', 'referenceField' => 'appFlowActionId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
            ...
            new Property('flowSequences', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('cascade_delete', 1), ]), ['entity' => 'flow_sequence', 'referenceField' => 'appFlowActionId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
