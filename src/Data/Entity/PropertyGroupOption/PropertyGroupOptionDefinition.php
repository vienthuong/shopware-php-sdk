...
class PropertyGroupOptionDefinition implements EntityDefinition
{
    ...
    public function getSchema() : Schema
    {
        return new Schema('property_group_option', new PropertyCollection([
            ...
            new Property('group', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource']]), ]), ['entity' => 'property_group', 'referenceField' => 'id', 'localField' => 'groupId', 'relation' => 'many_to_one', ]),
            new Property('translations', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('cascade_delete', 1), new Flag('required', 1), ]), ['entity' => 'property_group_option_translation', 'referenceField' => 'propertyGroupOptionId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
            new Property('productConfiguratorSettings', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('restrict_delete', 1), ]), ['entity' => 'product_configurator_setting', 'referenceField' => 'optionId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
            new Property('productProperties', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('cascade_delete', 1), new Flag('reversed_inherited', 'properties'), ]), ['entity' => 'product', 'referenceField' => 'id', 'localField' => 'id', 'relation' => 'many_to_many', ]),
            new Property('productOptions', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('restrict_delete', 1), ]), ['entity' => 'product', 'referenceField' => 'id', 'localField' => 'id', 'relation' => 'many_to_many', ]),
