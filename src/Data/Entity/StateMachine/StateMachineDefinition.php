...
class StateMachineDefinition implements EntityDefinition
{
    ...
    public function getSchema() : Schema
    {
        return new Schema('state_machine', new PropertyCollection([
            ...
            new Property('states', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource']]), new Flag('cascade_delete', 1), ]), ['entity' => 'state_machine_state', 'referenceField' => 'stateMachineId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
            new Property('transitions', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource']]), new Flag('cascade_delete', 1), ]), ['entity' => 'state_machine_transition', 'referenceField' => 'stateMachineId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
            ...
            new Property('translations', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('cascade_delete', 1), new Flag('required', 1), ]), ['entity' => 'state_machine_translation', 'referenceField' => 'stateMachineId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
            new Property('historyEntries', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), ]), ['entity' => 'state_machine_history', 'referenceField' => 'stateMachineId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
