...
class NumberRangeStateDefinition implements EntityDefinition
{
    ...
    public function getSchema() : Schema
    {
        return new Schema('number_range_state', new PropertyCollection([
            ...
            new Property('numberRange', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('restrict_delete', 1), ]), ['entity' => 'number_range', 'referenceField' => 'id', 'localField' => 'numberRangeId', 'relation' => 'one_to_one', ]),
