...
class ProductFeatureSetDefinition implements EntityDefinition
{
    ...
    public function getSchema() : Schema
    {
        return new Schema('product_feature_set', new PropertyCollection([
            ...
            new Property('products', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('set_null_on_delete', 1), new Flag('reversed_inherited', 'featureSet'), ]), ['entity' => 'product', 'referenceField' => 'featureSetId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
            new Property('translations', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('cascade_delete', 1), new Flag('required', 1), ]), ['entity' => 'product_feature_set_translation', 'referenceField' => 'productFeatureSetId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
