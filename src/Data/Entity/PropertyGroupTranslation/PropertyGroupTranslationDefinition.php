...
class PropertyGroupTranslationDefinition implements EntityDefinition
{
    ...
    public function getSchema() : Schema
    {
        return new Schema('property_group_translation', new PropertyCollection([
            ...
            new Property('propertyGroup', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), ]), ['entity' => 'property_group', 'referenceField' => 'id', 'localField' => 'propertyGroupId', 'relation' => 'many_to_one', ]),
