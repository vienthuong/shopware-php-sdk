...
class CustomerWishlistDefinition implements EntityDefinition
{
    ...
    public function getSchema() : Schema
    {
        return new Schema('customer_wishlist', new PropertyCollection([
            ...
            new Property('products', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('cascade_delete', 1), ]), ['entity' => 'customer_wishlist_product', 'referenceField' => 'wishlistId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
