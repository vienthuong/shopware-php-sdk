...
class MediaFolderDefinition implements EntityDefinition
{
    ...
    public function getSchema() : Schema
    {
        return new Schema('media_folder', new PropertyCollection([
            ...
            new Property('parent', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), ]), ['entity' => 'media_folder', 'referenceField' => 'id', 'localField' => 'parentId', 'relation' => 'many_to_one', ]),
            new Property('children', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('cascade_delete', 1), ]), ['entity' => 'media_folder', 'referenceField' => 'parentId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
            ...
            new Property('media', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('set_null_on_delete', 1), ]), ['entity' => 'media', 'referenceField' => 'mediaFolderId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
            new Property('defaultFolder', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), ]), ['entity' => 'media_default_folder', 'referenceField' => 'id', 'localField' => 'defaultFolderId', 'relation' => 'one_to_one', ]),
            new Property('configuration', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), ]), ['entity' => 'media_folder_configuration', 'referenceField' => 'id', 'localField' => 'configurationId', 'relation' => 'many_to_one', ]),
