...
class SalesChannelTypeTranslationDefinition implements EntityDefinition
{
    ...
    public function getSchema() : Schema
    {
        return new Schema('sales_channel_type_translation', new PropertyCollection([
            ...
            new Property('salesChannelType', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), ]), ['entity' => 'sales_channel_type', 'referenceField' => 'id', 'localField' => 'salesChannelTypeId', 'relation' => 'many_to_one', ]),
