...
class MailTemplateTypeTranslationDefinition implements EntityDefinition
{
    ...
    public function getSchema() : Schema
    {
        return new Schema('mail_template_type_translation', new PropertyCollection([
            ...
            new Property('mailTemplateType', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), ]), ['entity' => 'mail_template_type', 'referenceField' => 'id', 'localField' => 'mailTemplateTypeId', 'relation' => 'many_to_one', ]),
