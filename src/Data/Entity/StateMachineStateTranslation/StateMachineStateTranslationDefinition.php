...
class StateMachineStateTranslationDefinition implements EntityDefinition
{
    ...
    public function getSchema() : Schema
    {
        return new Schema('state_machine_state_translation', new PropertyCollection([
            ...
            new Property('stateMachineState', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), ]), ['entity' => 'state_machine_state', 'referenceField' => 'id', 'localField' => 'stateMachineStateId', 'relation' => 'many_to_one', ]),
