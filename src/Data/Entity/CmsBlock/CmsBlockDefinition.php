...
class CmsBlockDefinition implements EntityDefinition
{
    ...
    public function getSchema() : Schema
    {
        return new Schema('cms_block', new PropertyCollection([
            ...
            new Property('slots', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource']]), new Flag('cascade_delete', 1), ]), ['entity' => 'cms_slot', 'referenceField' => 'blockId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
