...
class ProductStreamDefinition implements EntityDefinition
{
    ...
    public function getSchema() : Schema
    {
        return new Schema('product_stream', new PropertyCollection([
            ...
            new Property('filters', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), ]), ['entity' => 'product_stream_filter', 'referenceField' => 'productStreamId', 'localField' => 'id', 'relation' => 'one_to_many', ]),
